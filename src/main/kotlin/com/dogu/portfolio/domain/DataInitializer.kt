package com.dogu.portfolio.domain

import com.dogu.portfolio.domain.constant.SkillType
import com.dogu.portfolio.domain.entity.*
import com.dogu.portfolio.domain.repository.*
...
class DataInitializer(
    ...
    fun initializeData() {
        ...
        println("Spring is running.. test data is initialized")

        val achievments = mutableListOf<Achievement>(
            Achievement(
        ...
        achievementRepository.saveAll(achievments)
        ...
        project2.addDetails(
            mutableListOf(
                ...
                ProjectDetail(content = "Github Repository", url = "https://github.com/yg-cho", isActive = true)
            )
        )
...
//controller, RestController, AdviceController - 전체세션관리(세션에서 직접관리할거냐, 미들웨어처럼할거냐)
//advice랑 intercepter 차이점 보기
